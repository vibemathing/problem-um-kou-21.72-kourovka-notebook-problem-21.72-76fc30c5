...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kou-21.72-kourovka-notebook-problem-21.72-76fc30c5-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KOU-21.72"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kou-21.72-kourovka-notebook-problem-21.72-76fc30c5-v1",
      "problem_contract_sha256": "09953317e787da3e6f5325a82d0195dd31d60da17dc266094cd26521f74c79e6",
      "problem_id": "problem:um-kou-21.72-kourovka-notebook-problem-21.72-76fc30c5",
      "route_id": "route:um-kou-21.72-kourovka-notebook-problem-21.72-76fc30c5-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kou-21.72-kourovka-notebook-problem-21.72-76fc30c5-source-fidelity-01",
      "graph_id": "graph:um-kou-21.72-kourovka-notebook-problem-21.72-76fc30c5-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kou-21.72-kourovka-notebook-problem-21.72-76fc30c5-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kou-21.72-kourovka-notebook-problem-21.72-76fc30c5-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "We say that a group is a Tarski monster if it is finitely generated, not cyclic, and all of its proper non-trivial subgroups are isomorphic to each other. a) Do there exist amenable torsion-free Tarski monsters? b) Do there exist amenable Tarski monsters of prime exponent?"
          },
          "statement_sha256": "70d53868cf6b5c663898098c4daa9561e123cdcd299007ea0025250b5174701f"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kou-21.72-kourovka-notebook-problem-21.72-76fc30c5-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kou-21.72-kourovka-notebook-problem-21.72-76fc30c5-root",
      "route_id": "route:um-kou-21.72-kourovka-notebook-problem-21.72-76fc30c5-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kou-21.72-14e06a9895ed",
        "url": "https://www.unsolvedmath.com/problems/KOU-21.72"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
